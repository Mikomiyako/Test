...
class Users(CoreModel, AbstractUser):
    ...
    skill = models.CharField(max_length=1255, verbose_name="技能", null=True, blank=True, help_text="技能")
    job_title = models.CharField(max_length=1255, verbose_name="职位标题", null=True, blank=True, help_text="职位标题")
