...
from dvadmin.system.views.evaluate.views import EvaluateViewSet
from dvadmin.system.views.file_list import FileViewSet
from dvadmin.system.views.job.views import JobViewSet
...
system_url.register(r'job', JobViewSet)
system_url.register(r'evaluate', EvaluateViewSet)
